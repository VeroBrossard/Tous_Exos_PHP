...
<span class="statement">Enoncé Exo 7 </span>
...
$date2 = strtotime($date1. ' + 20 days'); // On ajoute 20 jours
echo 'Timestamp dans 20 jours : ' . $date2 . '  par strtotime() <br><br>';
//echo 'date dans 20 jours :'. strftime('%A %d %B %Y', $date2) . '<br>';  Nooooooon !!!!

echo 'date dans 20 jours :' .date('d-m-Y', strtotime("+20 days"));
?>
 <br>
 ...
 <?php
  ...
  $start_date ->add(new dateInterval("P20D"));// Periode de 20 jrs
