<?php
//initialisation tableau dynamique des messages d'erreur
$errorMsg = [];
$infosUser =[];
//regex :
//Probleme avec les accents sur cette regex la ????.
...
$nations = [
  ...
  "LU" => "Luxembourg",
  "MO" => "Macao",
  "MK" => "Macédoine, l'ex-Rép. yougoslave de",
  "MG" => "Madagascar",
  "MY" => "Malaisie",
  "MW" => "Malawi",
  "MV" => "Maldives",
